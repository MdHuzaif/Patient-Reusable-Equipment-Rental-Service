                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        ...
                                        <h4>Renting Price:{{$v_published_product->product_price}} Tk</h4>
                                         <h4>Regular Price:{{$v_published_product->product_size}} Tk</h4>
                                          <h5>Availability:{{$v_published_product->product_color}}</h5>
                                        <p>{{$v_published_product->product_name}}</p>
                                        <a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                    </div>
                                    <div class="product-overlay">
                                        <div class="overlay-content">
                                        <h2>{{$v_published_product->product_price}} Tk per month</h2>
