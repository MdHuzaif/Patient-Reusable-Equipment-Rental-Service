                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> 01521494700</a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i> flopup.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="social-icons pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a target="_blank"  href="http://www.dribble.com"><i class="fa fa-dribbble"></i></a></li>
                                <li><a target="_blank"  href="http://www.google-plus.com"><i class="fa fa-google-plus"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                     ...
                     <?php if($customer_id != NULL){?>
                      ...
                      <?php  }else{?>
                        ...
                        <?php } ?> 
                                ...
                                <li class="dropdown"><a href="#">User-Sell<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="blog.html">Sign Up</a></li>
                                        <li><a href="blog-single.html">Login</a></li>
                                    </ul>
                                </li> 
